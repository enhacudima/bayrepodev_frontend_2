  ...
  <a-spin tip="Loading..." :spinning="spinning">
    ...
    <a-row>
      <div>
        ...
        <a-popconfirm
          placement="bottom"
          title="Sure Export File and move to Uploading?"
          @confirm="onExportLock()"
        >
          <a-button type="primary">
    ...
    <a-row :gutter="24">
      ...
      >
        <a-card hoverable :style="{ marginBottom: '24px' }">
          <a-statistic
            title="Check Telephone"
            :value="source.check_telephone"
            class="demo-class"
            :value-style="{ color: '#f5222d' }"
          >
          </a-statistic>
...
export default defineComponent({
  ...
  setup() {
    ...
    function dataGet() {
      ...
      axios.get('v1/wh-pending-approval/data').then((response) => {
    ...
    function forceUpdate() {
      ...
      axios.post('v1/wh-pending-approval/force-update').then((response) => {
        response
    ...
    const onExportLock = () => {
      axios.get('v1/wh-pending-approval/export-lock').then((response) => {
        response
        spinning.value = false
        message.success({
